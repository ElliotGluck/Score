...
<html data-wf-page="5a662d4ad234720001a4955a" data-wf-site="5a626c88e1788700018e6c6c">
<head>
    <script>
  if (location.protocol != 'https:')
{
 location.href = 'https:' + window.location.href.substring(window.location.protocol.length);
  ...
  <meta content="Seventh Period - Score" property="og:title">
    ...
    <div class="class-sidebar w-hidden-medium w-hidden-small w-hidden-tiny" data-ix="sidebar-load"><a href="#" class="link-block-2 w-inline-block"></a>
      <div class="row-2 w-row">
        <div class="column-7 w-col w-col-9 w-col-small-9 w-col-tiny-tiny-stack">
          ...
          <a href="#" class="class-side-bar w-inline-block w-clearfix">
            <div class="seventhperiodtext selected" data-ix="class-7-load"><?php echo preg_replace("/\([^)]+\)/","",$_SESSION["masterGradesVar"]["course"][6]["name"]); ?></div>
          </a>
        </div>
    ...
    <div class="class-block" data-ix="main-div-load"><a href="index.php" class="button w-hidden-main w-button">Back</a>
      ...
      <div class="row w-row">
        <div class="column-4 w-col w-col-5">
          ...
          <div class="classgrade <?php echo $seventhClassGradeColor; ?>" data-ix="gpa-load"><?php echo $_SESSION["masterGradesVar"]["course"][$currentClass]["grade"]; ?>%</div>
