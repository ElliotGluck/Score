...
<html data-wf-page="5a65a9935e467c0001494d58" data-wf-site="5a626c88e1788700018e6c6c">
<head>
    <script>
  if (location.protocol != 'https:')
{
 location.href = 'https:' + window.location.href.substring(window.location.protocol.length);
  ...
  <meta content="Fifth Period - Score" property="og:title">
    ...
    <div class="class-sidebar w-hidden-medium w-hidden-small w-hidden-tiny" data-ix="sidebar-load"><a href="#" class="link-block-2 w-inline-block"></a>
      <div class="row-2 w-row">
        <div class="column-7 w-col w-col-9 w-col-small-9 w-col-tiny-tiny-stack">
          ...
          <a href="#" class="class-side-bar fifthperiodlink w-inline-block w-clearfix">
            <div class="fifthperiodtext selected" data-ix="class-5-load"><?php echo preg_replace("/\([^)]+\)/","",$_SESSION["masterGradesVar"]["course"][4]["name"]); ?></div>
          </a>
          ...
          <a href="sixth.php" class="class-side-bar w-inline-block w-clearfix">
    ...
    <div class="class-block" data-ix="main-div-load"><a href="index.php" class="button w-hidden-main w-button">Back</a>
      ...
      <div class="row w-row">
        <div class="column-4 w-col w-col-5">
          ...
          <div class="classgrade <?php echo $fifthClassGradeColor; ?>" data-ix="gpa-load"><?php echo $_SESSION["masterGradesVar"]["course"][$currentClass]["grade"]; ?>%</div>
